...
export const metadata: Metadata = {
	...
	description:
		'Senior Web Developer with 4+ years of experience specializing in front-end JavaScript frameworks. Expert in Next.js, Vue.js, and modern web technologies. Led teams, achieved 40% performance improvements, and implemented CI/CD pipelines.',
	...
	openGraph: {
		title: 'Juan Daniel Sanchez Ramirez - Senior Web Developer',
		description: 'Senior Web Developer with 4+ years of experience specializing in front-end JavaScript frameworks.',
		type: 'website',
		locale: 'en_US',
	},
	twitter: {
